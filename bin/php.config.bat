...
echo ; php.ini Options  ;                                                                                                     >> %PHP_HOME%\php.ini
echo ;;;;;;;;;;;;;;;;;;;;                                                                                                     >> %PHP_HOME%\php.ini
echo ; Name for user-defined php.ini (.htaccess) files. Default is ".user.ini"                                                >> %PHP_HOME%\php.ini
echo ;user_ini.filename = ".user.ini"                                                                                         >> %PHP_HOME%\php.ini
echo                                                                                                                          >> %PHP_HOME%\php.ini
echo ; To disable this feature set this option to an empty value                                                              >> %PHP_HOME%\php.ini
echo ;user_ini.filename =                                                                                                     >> %PHP_HOME%\php.ini
echo                                                                                                                          >> %PHP_HOME%\php.ini
echo ; TTL for user-defined php.ini files (time-to-live) in seconds. Default is 300 seconds (5 minutes)                       >> %PHP_HOME%\php.ini
echo ;user_ini.cache_ttl = 300                                                                                                >> %PHP_HOME%\php.ini
echo                                                                                                                          >> %PHP_HOME%\php.ini
echo ;;;;;;;;;;;;;;;;;;;;                                                                                                     >> %PHP_HOME%\php.ini
...
echo ; On windows:                                                                                                            >> %PHP_HOME%\php.ini
...
echo ;session.cookie_secure =                                                                                                 >> %PHP_HOME%\php.ini
