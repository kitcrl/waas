...
function zContainer_count()
{
  return zContainer_init.length;
}

function zwscallback(b, sz)
{
  var i = 0;
...
function init_container()
{
  ...
  for ( i=0 ; i<zContainer_init.length ; i++ )
  {
	...
	zwebsocket = new zWebSocket(_ip, _port, zwscallback);
}

function getzWebSocket()
{
  return zwebsocket;
}